...
exports.reAllocateStrategy = {
    ...
    validate: function (_rt, message) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, /^reAllocateStrategy\s+0x[a-fA-F0-9]{40}\s+\[([\d]+,?)+\]$/.test(t)];
        });
    }); },
    handler: function (runtime, message, _state, _opts, callback) { return __awaiter(void 0, void 0, void 0, function () {
        var t, m, vaultAddress, allocStr, allocations, svc, bytesResponse, text;
        var _a;
        return __generator(this, function (_b) {
            t = (_a = message.content) === null || _a === void 0 ? void 0 : _a.text;
            m = t.match(/^reAllocateStrategy\s+(0x[a-fA-F0-9]{40})\s+\[([\d,]+)\]$/);
            if (!m) {
            ...
            vaultAddress = m[1], allocStr = m[2];
            allocations = allocStr.split(",").map(function (s) { return Number(s); });
            svc = runtime.getService(vault_1.VaultService.serviceType);
            bytesResponse = svc.reallocate(vaultAddress, allocations.map(function (allocation) { return BigInt(allocation); }));
            text = "Bytes response is ".concat(bytesResponse);
            callback === null || callback === void 0 ? void 0 : callback({
                text: text,
                content: { vaultAddress: vaultAddress, allocations: allocations, bytesResponse: bytesResponse },
            });
