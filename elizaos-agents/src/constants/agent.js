...
var AGENTS = [
    {
        ...
        name: "Atlas",
        plugins: __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([
            // Core plugins first
            "@elizaos/plugin-sql"
        ], (process.env.ANTHROPIC_API_KEY ? ["@elizaos/plugin-anthropic"] : []), true), (process.env.OPENROUTER_API_KEY ? ["@elizaos/plugin-openrouter"] : []), true), (process.env.OPENAI_API_KEY ? ["@elizaos/plugin-openai"] : []), true), (process.env.OLLAMA_API_ENDPOINT ? ["@elizaos/plugin-ollama"] : []), true), (process.env.GOOGLE_GENERATIVE_AI_API_KEY
            ? ["@elizaos/plugin-google-genai"]
            : []), true), (!process.env.GOOGLE_GENERATIVE_AI_API_KEY &&
            !process.env.OLLAMA_API_ENDPOINT &&
            !process.env.OPENAI_API_KEY
            ? ["@elizaos/plugin-local-ai"]
            : []), true), (process.env.DISCORD_API_TOKEN ? ["@elizaos/plugin-discord"] : []), true), (process.env.TWITTER_API_KEY &&
            process.env.TWITTER_API_SECRET_KEY &&
            process.env.TWITTER_ACCESS_TOKEN &&
            process.env.TWITTER_ACCESS_TOKEN_SECRET
            ? ["@elizaos/plugin-twitter"]
            : []), true), (process.env.TELEGRAM_BOT_TOKEN ? ["@elizaos/plugin-telegram"] : []), true), (!process.env.IGNORE_BOOTSTRAP ? ["@elizaos/plugin-bootstrap"] : []), true),
        ...
        vaults: vault_1.VAULTS.filter(function (vault) {
            return vault.agentAddress === "0xDDd09e89D654F284da540B8AbC5C6Fe8ED330d8b";
        }),
    ...
    },
    {
        ...
        vaults: vault_1.VAULTS.filter(function (vault) {
            return vault.agentAddress === "0x85D365964271383c095c730dfC5679267b6173b9";
        }),
    ...
    },
    {
        ...
        vaults: vault_1.VAULTS.filter(function (vault) { return vault.agentAddress === "0x3333"; }),
    ...
    },
    {
        ...
        vaults: vault_1.VAULTS.filter(function (vault) { return vault.agentAddress === "0x4444"; }),
    ...
    },
    {
        ...
        vaults: vault_1.VAULTS.filter(function (vault) { return vault.agentAddress === "0x5555"; }),
