...
exports.exitStrategy = {
    ...
    validate: function (_rt, message) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, /^exitStrategy\s+0x[a-fA-F0-9]{40}\s+0x[a-fA-F0-9]{40}$/.test(t)];
        });
    }); },
    handler: function (runtime, message, _state, _opts, callback) { return __awaiter(void 0, void 0, void 0, function () {
        var t, m, vaultAddress, strategyToRemove, svc, bytesResponse, text;
        var _a;
        return __generator(this, function (_b) {
            t = (_a = message.content) === null || _a === void 0 ? void 0 : _a.text;
            m = t.match(/^exitStrategy\s+(0x[a-fA-F0-9]{40})\s+(0x[a-fA-F0-9]{40})$/);
            if (!m) {
            ...
            vaultAddress = m[1], strategyToRemove = m[2];
            svc = runtime.getService(vault_1.VaultService.serviceType);
            bytesResponse = svc.removeStrategy(vaultAddress, strategyToRemove);
            text = "Bytes response is ".concat(bytesResponse);
            callback === null || callback === void 0 ? void 0 : callback({
                text: text,
                content: { vaultAddress: vaultAddress, strategyToRemove: strategyToRemove, bytesResponse: bytesResponse },
            });
