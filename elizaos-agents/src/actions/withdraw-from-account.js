...
exports.withdrawToAccount = {
    ...
    validate: function (_runtime, message) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, /^withdrawToAccount\s+0x[a-fA-F0-9]{40}\s+\d+\s+0x[a-fA-F0-9]{40}$/.test(t)];
        });
    }); },
    handler: function (runtime, message, _state, __unkwown, callback) { return __awaiter(void 0, void 0, void 0, function () {
        var t, m, _, vaultAddress, lpStr, account, svc, lpAmount, bytesResponse, text;
        var _a;
        return __generator(this, function (_b) {
            t = (_a = message.content) === null || _a === void 0 ? void 0 : _a.text;
            m = t.match(/^withdrawToAccount\s+(0x[a-fA-F0-9]{40})\s+(\d+)\s+(0x[a-fA-F0-9]{40})$/);
            if (!m) {
            ...
            _ = m[0], vaultAddress = m[1], lpStr = m[2], account = m[3];
            svc = runtime.getService(vault_1.VaultService.serviceType);
            lpAmount = BigInt(lpStr);
            bytesResponse = svc.withdraw(vaultAddress, lpAmount, account);
            text = "Bytes response is ".concat(bytesResponse);
            callback === null || callback === void 0 ? void 0 : callback({
                text: text,
                content: { vaultAddress: vaultAddress, lpAmount: lpAmount, account: account, bytesResponse: bytesResponse },
            });
