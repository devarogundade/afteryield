...
exports.entryStrategy = {
    ...
    validate: function (_rt, message) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            return [2 /*return*/, /^entryStrategy\s+0x[a-fA-F0-9]{40}\s+0x[a-fA-F0-9]{40}$/.test(t)];
        });
    }); },
    handler: function (runtime, message, _state, _opts, callback) { return __awaiter(void 0, void 0, void 0, function () {
        var t, m, vaultAddress, newStrategy, svc, bytesResponse, text;
        var _a;
        return __generator(this, function (_b) {
            t = (_a = message.content) === null || _a === void 0 ? void 0 : _a.text;
            m = t.match(/^entryStrategy\s+(0x[a-fA-F0-9]{40})\s+(0x[a-fA-F0-9]{40})$/);
            if (!m) {
            ...
            vaultAddress = m[1], newStrategy = m[2];
            svc = runtime.getService(vault_1.VaultService.serviceType);
            bytesResponse = svc.addStrategy(vaultAddress, newStrategy);
            text = "Bytes response is ".concat(bytesResponse);
            callback === null || callback === void 0 ? void 0 : callback({
                text: text,
                content: { vaultAddress: vaultAddress, newStrategy: newStrategy, bytesResponse: bytesResponse },
            });
